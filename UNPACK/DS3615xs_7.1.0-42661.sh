curl -L https://cndl.synology.cn/download/DSM/release/7.1/42661-1/DSM_DS3615xs_42661.pat -o ds.pat
mkdir synoesp
curl --location https://cndl.synology.cn/download/DSM/release/7.0.1/42218/DSM_DS3615xs_42218.pat --output oldpat.tar.gz
...
mv archive.tar.gz ../ds3615xs_42661.pat
cd ../
sudo rm -rf ds.pat oldpat.tar.gz pat synoesp
sha256sum ds3615xs_42661.pat
