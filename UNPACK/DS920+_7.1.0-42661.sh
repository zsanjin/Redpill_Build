curl -L https://cndl.synology.cn/download/DSM/release/7.1/42661-1/DSM_DS920+_42661.pat -o ds.pat
mkdir synoesp
curl --location https://cndl.synology.cn/download/DSM/release/7.0.1/42218/DSM_DS920+_42218.pat --output oldpat.tar.gz
